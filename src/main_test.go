...
func TestGetUserPositiv(t *testing.T) {
	...
	allowed := GetUser("test_superuser", "test_superuser", "test_client_id")
	if !allowed {
...
func TestGetUserNegativ(t *testing.T) {
	...
	allowed := GetUser("wrong_user", "wrong_password", "wrong_client_id")
	if allowed {
...
func TestGetUserWithTokenPositiv(t *testing.T) {
	...
	allowed := GetUser("mock_token_superuser", "OAUTH2 BEARER TOKEN", "mock_client_id")
	if !allowed {
...
func TestGetUserWithTokenNegative(t *testing.T) {
	...
	allowed := GetUser("wrong_token", "OAUTH2 BEARER TOKEN", "wrong_client_id")
	if allowed {
...
func TestGetSuperuserPositiv(t *testing.T) {
	...
	GetUser("test_superuser", "test_superuser", "test_client_id")
...
func TestGetSuperuserNegativ(t *testing.T) {
	...
	GetUser("test_normaluser", "test", "test_client_id")
...
func TestRefreshExpiredAccessTokenWithoutCrediantials(t *testing.T) {
	...
	if CI {
		...
		GetUser("mock_token_superuser", "OAUTH2 BEARER TOKEN", "test_client_id")
...
func TestACLWithPatternSubstitution(t *testing.T) {
	...
	GetUser("test_normaluser", "test_normaluser", "test_client_id")
